...
*Last updated: 2026-06-07 — reflects the system as delivered for AI Agenthon 2026 (Use Case ID: 1).*
...
│  • /compass/probe   /demo   /submission_demo     │
└────────────────────────────────────────────────┘
...
| `MAX_ITERATIONS` | 2 | Maximum engineer tasks processed per run (keeps total runtime under 15 min) |
...
│   ├── public_data.py          Public dataset helpers
│   └── logging_config.py
├── frontend/
