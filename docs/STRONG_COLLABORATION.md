...
├── README.md                    ✓ Main docs
├── app/
│   ├── data_types.py            ✓ Data models (AgentRole, Task, Project, Message)
...
│   ├── orchestrator.py          ✓ Coordination wrapper
...
├── frontend/
│   └── dist/                    ✓ Static web UI (served by FastAPI)
└── docs/
    ├── ARCHITECTURE.md          ✓ Design docs
    ├── AGENTS.md                ✓ Agent specs
    ├── COLLABORATION.md         ✓ Collaboration patterns
    ├── STRONG_COLLABORATION.md  ✓ Collaboration evidence
